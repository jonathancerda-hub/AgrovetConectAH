...
const equipoItems = [
  { text: 'Solicitar Colaborador', icon: <PersonAddIcon />, component: <SolicitarColaboradorComponent /> },
];
                  ...
                  <ListItem key={item.text} disablePadding sx={{ display: 'block' }}>
                    <ListItemButton
                      sx={{
                        ...
                        '&.Mui-selected': {
                          backgroundColor: 'transparent', // No cambia el fondo al seleccionar
                    ...
                    >
                      <ListItemIcon sx={{ minWidth: 0, mr: 2, justifyContent: 'center', alignItems: 'center' }}>
                        <Box sx={{ width: 5, height: 5, bgcolor: 'text.disabled', borderRadius: '50%' }} />
                      </ListItemIcon>
